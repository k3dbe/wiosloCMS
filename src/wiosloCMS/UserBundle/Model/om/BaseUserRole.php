...
abstract class BaseUserRole extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'wiosloCMS\\UserBundle\\Model\\UserRolePeer';
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = UserRoleQuery::create()
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO `UserRole` (%s) VALUES (%s)',
    ...
    {
        return (string) $this->exportTo(UserRolePeer::DEFAULT_STRING_FORMAT);
    }
